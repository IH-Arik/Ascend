"""Specialist session schemas (Mental Performance/Nutritionist/Chaplain)."""
...
class SpecialistSessionCreate(BaseModel):
    """Schedule a real specialist session, individual or group."""
...
class SpecialistSessionUpdate(BaseModel):
...
class SpecialistSessionResponse(BaseModel):
    """A single scheduled specialist session."""
